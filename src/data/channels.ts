...
export const INITIAL_CHANNELS: Channel[] = [
  ...
  },
  {
    id: 'history-tv',
    name: 'HISTORY TV',
    streamUrl: 'https://yowaimo.in/Sflex-ArtlPVT0719/HISTORY_TV18_HD.m3u8',
    category: 'Entertainment',
  ...
  },
  {
    ...
    useDirectStream: true,
    category: 'Sports',
    description: 'T Sports 3 Stream',
  },
  {
    id: 't-sports 4',
    name: 'T SPORTS 4',
    streamUrl: 'https://iptv.aethelcode.workers.dev/TnMn5kZz8aLm/tracks-v1a1/mono.ts.m3u8',
    useDirectStream: true,
    category: 'Sports',
    description: 'T Sports 4 Stream',
  },
  {
    id: 'ptv-sports',
    name: 'PTV SPORTS',
